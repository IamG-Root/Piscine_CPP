...
/*   Updated: 2023/07/22 19:10:41 by scastagn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string name)
{
    ...
    this->_ep = 10;
    this->_admg = 0;
    std::cout<<name<<" ClapTrap spawned"<<std::endl;
    return ;
}

ClapTrap::ClapTrap(ClapTrap const &src)
{
    std::cout<<src._name<<" ClapTrap spawned"<<std::endl;
    *this = src;
    return ;
}
...
ClapTrap::~ClapTrap( void )
{
    std::cout<<this->_name<<" ClapTrap has been destroyed"<<std::endl;
    return ;
}
...
void ClapTrap::attack(const std::string &target)
{
    if (this->_ep > 0)
    {
        std::cout<<"ClapTrap "<<this->_name<<" attacks "<<target<<" causing "<<this->_admg<<" points of damage!"<<std::endl;
        this->_ep -= 1;
    }
    else
        std::cout<<"ClapTrap "<<this->_name<<" has no more energy points to attack!"<<std::endl;
    return ;
}
